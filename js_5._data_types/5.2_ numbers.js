...
/* Задача 5.2.6 Случайное целое число от min до max
...
// НЕ Правильное решение из книги (аналогично моему)

// Самое простое, но неправильное решение – 
// генерировать случайное число от min до max и округлять его:
...
// Вероятность получить min и max значения в 2 раза меньше, 
// чем любое другое число.

// Если вы запустите приведённый выше пример, то заметите, 
// что 2 появляется чаще всего.

// Это происходит потому, что метод Math.round() 
...
// что 1 получает в 2 раза меньше значений, чем 2. 
// То же самое с 3

// Правильное решение задачи №1

// Одно из них – правильно указать границы интервала.
// Чтобы выровнять интервалы, 
// мы можем генерировать числа от 0.5 до 3.5, 
...
// Правильное решение задачи №2

// Другое правильное решение – это использовать Math.floor 
// для получения случайного числа от min до max + 1:
